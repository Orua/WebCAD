...
export const DISPLAY_DEFAULTS=Object.freeze({defaultColor:'#aac4d9',defaultFinish:'design',background:'#eef1f5',environmentMode:'studio',exposure:1,environmentIntensity:0.8,environmentRotation:0,roughnessOffset:0.08,lightAzimuth:-60,lightElevation:55,keyIntensity:1.3,fillIntensity:0.6,ambientIntensity:0.7});
...
export const DISPLAY_RANGES=Object.freeze({exposure:[0.1,3],environmentIntensity:[0,3],environmentRotation:[-180,180],roughnessOffset:[0,0.6],lightAzimuth:[-180,180],lightElevation:[-89,89],keyIntensity:[0,6],fillIntensity:[0,6],ambientIntensity:[0,6]});
...
export function validateDisplayPreferences(patch){
  ...
  for(const [key,value]of Object.entries(patch)){
    ...
    else if(key==='defaultColor'||key==='background'){if(typeof value!=='string'||!/^#[0-9a-f]{6}$/i.test(value))fail();}
