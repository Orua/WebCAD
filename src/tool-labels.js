...
export const TOOL_LABELS = Object.freeze({
  ...
  fillet:'圆角',chamfer:'倒角',shell:'抽壳',hole:'打孔',linearPattern:'直线阵列',circularPattern:'环形阵列',remove:'删除',import:'导入',
  ...advancedNames,...referenceNames,...referenceProfileNames,
  vectorProfile:'导入路径',arcProfile:'解析线弧轮廓',quickModel:'快捷模型',multiHole:'多位置打孔',
