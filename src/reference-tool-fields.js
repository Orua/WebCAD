...
export const referenceNotes = {
  ...
  faceBoundary:'先选中一张面，提取包括内孔在内的全部边界。保留原模型，生成精确线框；尚不提供轮廓节点编辑或自动拉伸。',
...
export const referenceOperations = {
  ...
  faceBoundary:{description:referenceNotes.faceBoundary,refs:1,paramsSchema:{type:'object',additionalProperties:false,required:['faceId'],properties:{faceId:{type:'integer',minimum:0}}}},
